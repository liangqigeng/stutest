<?php /*a:3:{s:64:"D:\laragon\www\stutests\application\index\view\student\edit.html";i:1592542150;s:65:"D:\laragon\www\stutests\application\index\view\public\header.html";i:1592569204;s:65:"D:\laragon\www\stutests\application\index\view\public\bottom.html";i:1592545332;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<article class="page-container">
	<form action="" method="" class="form form-horizontal" id="form-member-add">
		<input type="hidden" id="uid" value="<?php echo htmlentities($uid); ?>">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>姓名:</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo htmlentities($username); ?>" placeholder="" id="username" name="username">
			</div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
				<select class="select" size="1" name="" id="grade">
					<option value="<?php echo htmlentities($gid); ?>" selected><?php echo htmlentities($grade); ?></option>
...
<script type="text/javascript">
	function check() {
		...
		$.ajax({
			url: "<?php echo URL('index/student/edit'); ?>",
			type: 'get',
			dataType: 'json',
			data: {
				username: username,
